...
public class TextAlignerTest {
    @Test
    void sampleTests() {
//        assertEquals("123  45\n6", TextAligner.justify("123 45 6", 7));
//        assertEquals("123", TextAligner.justify("123", 7));
//        assertEquals("", TextAligner.justify("", 10));
        assertEquals("SuperLongOneLineWord", TextAligner.justify("SuperLongOneLineWord", 20));
    }
    ...
    void descriptionExample() {
        ...
        assertEquals(expected, TextAligner.justify(LIPSUM, 30));
    }
}
